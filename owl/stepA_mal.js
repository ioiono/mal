          ...
          case 'try*': {
            try {
              ...
              if (
                ...
                if (!types_1.isOwlType(e)) {
                  e = new types_1.OwlString(e.message);
                }
                return EVAL(c.list[2], new env_1.Env(env, [errorSymbol], [e]));
              } else {
                throw e;
              }
            }
...
replEnv.set(
  new types_1.OwlSymbol('*host-language*'),
  new types_1.OwlString('TypeScript'),
);
